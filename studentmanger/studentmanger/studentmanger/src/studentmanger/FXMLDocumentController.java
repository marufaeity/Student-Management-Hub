...
public class FXMLDocumentController {
    ...
    private static final ObservableList<officer> cachedStudentList = FXCollections.observableArrayList(); // ✅ ADDED
    ...
    private void loadStudents() {
        ...
        try (Statement statement = connection.createStatement();
            ...
            cachedStudentList.setAll(studentList); // ✅ ADDED
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    private void openAttendanceWindow(ActionEvent event) {
        try {
            ...
            e.printStackTrace();
            showAlert("Error", "Unable to open attendance window.", Alert.AlertType.ERROR);
        }
    }

    // ✅ Fixed: Now correctly returns a copy of cached students
    public static ObservableList<officer> getStudentListStatic() {
        return FXCollections.observableArrayList(cachedStudentList);
    }
